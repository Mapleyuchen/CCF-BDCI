...
class EnhancedMemoryInput(ConstructionInput):
...
@harness_element(
    ...
    description="Multi-level memory architecture with hybrid retrieval for improved context management.",
)
def _build_enhanced_memory_rail(
    params: dict[str, Any],
    context: Any,
) -> EnhancedMemoryRail:
    inp = EnhancedMemoryInput.resolve(params, context)
