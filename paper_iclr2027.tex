...
significant improvements over the baseline: retrieval accuracy improved from 0\% to 22.2\%,
task coherence doubled from 0.500 to 1.000 (+100\%), and cross-session retention
tripled from 30\% to 90\% (+200\%). Additionally, we achieve 88\% team collaboration
efficiency through our novel memory synchronization mechanism.
...
search \citep{example2024}, episodic memory for experience replay, and hierarchical
memory structures \citep{memoryarch2023}.

\subsection{Multi-Agent Collaboration}

Multi-agent systems face unique challenges in information sharing and coordination.
Existing work has focused on communication protocols and task decomposition \citep{multiagent2024},
but memory sharing remains underexplored.
...
on JiuwenSwarm, we demonstrated significant improvements: retrieval accuracy
improved from 0\% to 22.2\%, task coherence doubled (+100\%), and cross-session
retention tripled (+200\%). Our team collaboration mechanism achieved 88\%
sharing efficiency. Our work provides a practical and effective approach to
agent memory management with immediate applicability to real-world systems.

\subsubsection*{Acknowledgments}
We thank the openJiuwen community for providing the JiuwenSwarm framework.

\subsubsection*{AI Use Statement}
In this work, we used generative AI tools for literature survey assistance and
experimental code scaffolding. We did not use AI for core research ideation,
method design, or result interpretation. All AI-generated code was manually
reviewed, tested, and validated by the authors. We take full responsibility
for the final content of this work.

\subsubsection*{Reproducibility Statement}
Our implementation is based on JiuwenSwarm (commit hash available in supplementary
materials). All experimental scripts, configuration files, and data are included
in the supplementary materials. Detailed hyperparameters and evaluation protocols
are provided in the Method and Experiments sections.
